...
SAVE_PATH = '../pic_results_v2.0/trace_divergence/'

def divergence_plot(y1,y2,s,save_path=SAVE_PATH,quiver_flag=False):
    # read data
    ...
    plt.subplots_adjust(top=0.8,bottom=0.1,left=0.1,right=0.9,hspace=0.2,wspace=0.2)
    ...
    ax.set_global()
    # plot buoy trace
    ax.scatter(buoy.lon,buoy.lat,1,\
    ...
    for i in range(0,num,1):
        ...
        # scatter
        ax.scatter(trace_lon_i[::density],trace_lat_i[::density],0.1,
...
for s in buoy_s_2015:
    divergence_plot(2015,2016,s)
# plot 2016
for s in buoy_s_2016:
    divergence_plot(2016,2017,s)
